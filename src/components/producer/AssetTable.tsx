    ...
    <div className="h-[calc(100vh-14rem)] overflow-auto rounded-lg border border-white/20">
      <table className="w-full border-collapse">
        ...
        <thead className="sticky top-0 z-20">
          <tr className="bg-[#0A0A0A]/75 backdrop-blur-[50px] border-b border-white/20">
            <th className="px-4 py-3 text-left text-sm font-semibold text-white sticky left-0 bg-[#0A0A0A]/75 backdrop-blur-[50px] z-30">
              Name
            </th>
        ...
        <tbody>
          {assets.map((asset) => {
            ...
            return (
              ...
              >
                {/* Name */}
                <td className="px-4 py-3 text-gray-200 sticky left-0 bg-white/5 backdrop-blur-[50px] z-10 whitespace-nowrap">
