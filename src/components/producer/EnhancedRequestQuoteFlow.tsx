                        ...
                        return (
                          <div
                            ...
                            className={`
                              ...
                              ${isAlreadyContacted ? 'opacity-60' : 'hover:border-purple-300 cursor-pointer'}
                            `}
                  ...
                  <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-600">To: {currentEmail.contactEmail}</span>
                      </div>
                          ...
                          {currentSupplier.contact_persons.map((person, index) => (
                            <div key={index} className="flex items-center gap-4 text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                {person.is_primary && (
                                  <div className="flex items-center gap-1 px-2 py-0.5 bg-yellow-100 text-yellow-700 rounded text-xs">
