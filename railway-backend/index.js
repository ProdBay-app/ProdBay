...
// Test endpoint for quote history table
app.get('/api/test-history-table', async (req, res) => {
  try {
...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      'GET /api/quotes/:quoteId/history': 'Get quote status history for a specific quote',
