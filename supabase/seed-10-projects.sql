-- ProdBay Comprehensive Seed Data - 10 Projects
...
('Elite Event Productions', 'contact@eliteevents.example.com', ARRAY['Staging', 'Audio', 'Lighting'], '[{"name": "Alex Martinez", "email": "alex@eliteevents.example.com", "role": "Event Director", "phone": "+1-555-0501", "is_primary": true}]'::jsonb),
('Premier Print Solutions', 'contact@premierprint.example.com', ARRAY['Printing', 'Graphics', 'Banners'], '[{"name": "Sarah Johnson", "email": "sarah@premierprint.example.com", "role": "Sales Manager", "phone": "+1-555-0101", "is_primary": true}]'::jsonb),
('Gourmet Catering Plus', 'orders@gourmetcatering.example.com', ARRAY['Catering', 'Food', 'Beverages'], '[{"name": "Maria Garcia", "email": "maria@gourmetcatering.example.com", "role": "Catering Manager", "phone": "+1-555-0601", "is_primary": true}]'::jsonb),
('Professional Audio Systems', 'sales@proaudio.example.com', ARRAY['Audio', 'Lighting', 'Staging'], '[{"name": "David Chen", "email": "david@proaudio.example.com", "role": "Technical Director", "phone": "+1-555-0301", "is_primary": true}]'::jsonb),
('Dynamic Lighting Co', 'contact@dynamiclighting.example.com', ARRAY['Lighting', 'Audio', 'Staging'], '[{"name": "Rachel Brown", "email": "rachel@dynamiclighting.example.com", "role": "Sales Lead", "phone": "+1-555-0401", "is_primary": true}]'::jsonb),
('Complete Event Solutions', 'contact@completeevents.example.com', ARRAY['Staging', 'Audio', 'Lighting', 'Catering', 'Security'], '[{"name": "Michael Torres", "email": "michael@completeevents.example.com", "role": "Project Manager", "phone": "+1-555-0701", "is_primary": true}]'::jsonb),
('Fresh Bites Catering', 'info@freshbites.example.com', ARRAY['Food', 'Catering', 'Beverages'], '[{"name": "Emma Wilson", "email": "emma@freshbites.example.com", "role": "Operations Manager", "phone": "+1-555-0801", "is_primary": true}]'::jsonb),
('Grand Stage Solutions', 'info@grandstage.example.com', ARRAY['Staging', 'Lighting', 'Audio'], '[{"name": "James Anderson", "email": "james@grandstage.example.com", "role": "Stage Director", "phone": "+1-555-0901", "is_primary": true}]'::jsonb),
('Banner Masters', 'sales@bannermasters.example.com', ARRAY['Banners', 'Printing', 'Graphics'], '[{"name": "Lisa Wang", "email": "lisa@bannermasters.example.com", "role": "Production Manager", "phone": "+1-555-1001", "is_primary": true}]'::jsonb),
('Mega Event Productions', 'sales@megaevents.example.com', ARRAY['Staging', 'Audio', 'Lighting', 'Catering', 'Transport', 'Security'], '[{"name": "Robert Kim", "email": "robert@megaevents.example.com", "role": "Executive Producer", "phone": "+1-555-1101", "is_primary": true}]'::jsonb);
...
-- AI Processing Logs (if table exists)
DO $$
BEGIN
...
-- AI Allocations (if table exists)
DO $$
BEGIN
...
-- Summary
SELECT 'Seed Complete' as status, (SELECT COUNT(*) FROM projects) as projects, (SELECT COUNT(*) FROM assets) as assets, (SELECT COUNT(*) FROM suppliers) as suppliers, (SELECT COUNT(*) FROM quotes) as quotes;
